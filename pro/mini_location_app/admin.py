...
from .models import (
    PlayerProgress, MiniNovella, MiniGame, EmployeeGame, Reward,
    PlayerNovellaProgress, PlayerGameProgress, PlayerEmployeeGameProgress, PlayerRewardProgress
)
...
class PlayerProgressAdmin(admin.ModelAdmin):
    ...
    inlines = [PlayerNovellaProgressInline, PlayerGameProgressInline, PlayerEmployeeGameProgressInline,
