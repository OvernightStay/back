...
class PlayerNovellaProgress(models.Model):
    player_progress = models.ForeignKey(PlayerProgress, on_delete=models.CASCADE, related_name='novella_progress',
                                        verbose_name='Прогресс игрока')
    novella = models.ForeignKey(MiniNovella, on_delete=models.CASCADE, verbose_name='Мини-новелла')
...
class PlayerGameProgress(models.Model):
    player_progress = models.ForeignKey(PlayerProgress, on_delete=models.CASCADE, related_name='game_progress',
                                        verbose_name='Прогресс игрока')
    game = models.ForeignKey(MiniGame, on_delete=models.CASCADE, verbose_name='Мини-игра')
...
class PlayerEmployeeGameProgress(models.Model):
    player_progress = models.ForeignKey(PlayerProgress, on_delete=models.CASCADE, related_name='employee_game_progress',
                                        verbose_name='Прогресс игрока')
    employee_game = models.ForeignKey(EmployeeGame, on_delete=models.CASCADE, verbose_name='Игра сотрудником')
...
class PlayerRewardProgress(models.Model):
    player_progress = models.ForeignKey(PlayerProgress, on_delete=models.CASCADE, related_name='reward_progress',
                                        verbose_name='Прогресс игрока')
